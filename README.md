...
Bu programda yazılımsal olarak bir hata bulunmamasına rağmen, önceden yazmış olduğum bir proje olduğu için sürdürülebilirlik açısından bazı sıkıntılar vardır. Daha düzgün tekniklerle yazılmış bir proje için Northwind projesi repomu inceleyebilirsiniz. 
